...
<body>
    ...
    <nav class="navbar navbar-expand bg-light fixed-top">
        ...
        </button><a class="navbar-brand" href="#"><i class="bi bi-stars"></i> Doorsmeer</a>
    ...
    <div>
        <div class="sidebar p-4 bg-light fixed-left" id="sidebar">
            ...
            <li>
                <a class="btn btn-dark text-white active" href="../orderdetail/orderdetail.php">
...
$result = mysqli_query($mysqli, "SELECT * FROM orderdetail");
?>
    ...
    while($user_data = mysqli_fetch_array($result)){
        echo "<tr>";
        echo "<td>".$user_data['OrderDetailID']."</td>";
        echo "<td>".$user_data['OrderID']."</td>";
        echo "<td>".$user_data['ServiceID']."</td>";
        echo "<td>".$user_data['Subtotal']."</td>";
        echo "<td><a href='edit.php?OrderDetailID=".$user_data['OrderDetailID'].
    "' class='btn btn-warning'>Edit</a> | 
        <a href='delete.php?OrderDetailID=".$user_data['OrderDetailID']."' class='btn btn-danger'>Delete</a></td>";
        echo "</tr>";
}
