...
<body>
    ...
    <div>
        <div class="sidebar p-4 bg-light fixed-left" id="sidebar">
            ...
            <li>
                <a class="btn btn-dark text-white active" href="../staff/staff.php">
...
?>
    ...
    while($user_data = mysqli_fetch_array($result)){
        ...
        echo "<td><a href='edit.php?idsupplier=".$user_data['StaffID'].
        "' class='btn btn-warning'>Edit</a> | 
            <a href='delete.php?idsupplier=".$user_data['StaffID']."' class='btn btn-danger'>Delete</a></td>";
            echo "</tr>";
    }
